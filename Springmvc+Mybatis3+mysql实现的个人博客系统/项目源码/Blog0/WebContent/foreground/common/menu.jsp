		  ...
		  <div class="container-fluid">
		    ...
		    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1" >
		      <ul class="nav navbar-nav">
		        ...
		        <li><a href="${pageContext.request.contextPath}/download.html"><font color="black"><strong>技术介绍</strong></font></a></li>
		        <li><a href="https://www.csdn.net"><font color="black"><strong>更多内容</strong></font></a></li>
